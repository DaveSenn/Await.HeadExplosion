...
" );
    ...
    private static async Task Level2( StackTracesOhMy runnable )
    {
    ...
    private static async Task Level4( StackTracesOhMy runnable )
    {
        await Level5( runnable );
    }

    private static async Task Level5( StackTracesOhMy runnable )
    {
